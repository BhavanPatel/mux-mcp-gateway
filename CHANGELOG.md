...
### Fixed
-  detect HTTP 401 responses as auth-needed in Phase 1 connect
...
### Fixed
-  strip ANSI escape codes in CLI tests for CI compatibility
...
### Fixed
-  add pre-commit auto-format hook, fix lint warnings, remove unused imports
...
### Added
-  add log-to-file support and troubleshooting guide
